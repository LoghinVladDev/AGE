//
// Created by Vlad-Andrei Loghin on 14.09.23.
//
...
enum class TestFlag : cds::uint8 { First = 0x01, Second = 0x02, Third = 0x04, Fourth = 0x08 };
using Flags = std::underlying_type_t<TestFlag>;
using enum TestFlag;
} // namespace

template <> struct FlagEnum<TestFlag> : cds::meta::TrueType {
